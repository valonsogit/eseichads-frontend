...
<template>
    <div
        class="relative md:hidden flex items-center justify-center h-full text-white border-2 border-opacity-20 px-1 md:px-2 rounded cursor-pointer overflow-hidden"
